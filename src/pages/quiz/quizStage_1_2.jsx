    ...
    const handleSubmit = async () => {
        try {
            const response = await axios.post("http://127.0.0.1:5000/predict", {
                jawaban_asli: "Bapak nganggo surjan lan jarik batik",
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                Apa bahasa jawa saka ukara <span style={{ color: '#FF7A00', fontWeight: 700 }}>"Ayah menggunakan surjan dan kain batik"</span>?
            </div>
...
export default QuizStage1Number2;